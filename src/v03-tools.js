(function () {
  ...
  function createManualLead(input, id) {
  ...
  function parseCustomerCsv(text, startId = 1) {
  ...
  function mergeImportedLeads(existingLeads, importedLeads, startId = existingLeads.length + 1) {

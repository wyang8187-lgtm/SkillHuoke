export const storageKey = "skillhuoke:v0.2:workspace";
...
export function createTemplateMessage(templateId, lead, product) {
...
export function buildSavedState({ leads, selectedId, taskStatus }) {
  return {
    version: "0.2",
...
export function buildCsv(leads, { product, templateId } = {}) {
  const headers = [
    "公司名",
    "国家",
    "城市",

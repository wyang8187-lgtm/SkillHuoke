...
export function authenticityScore(lead, product = "") {
  const reasons = [];
  const risks = [];
  let score = 0;
...
export function classifyLeadStage(result) {
...
export function buildSearchStrategy({ product, country, buyerTypes }) {
...
export function buildDevelopmentPlan(lead, authenticity) {

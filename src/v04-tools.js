(function () {
  const defaultTags = ["高潜力", "需核验WhatsApp", "已发开发信", "已回复", "报价中", "重点客户"];
  ...
  function createFollowUp({ date, channel, content, result, nextAction }) {
    return {
